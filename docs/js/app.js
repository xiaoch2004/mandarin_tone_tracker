...
function stopRecording() {
  ...
  rec.exportWAV(createResult);
}

function createResult(blob) {
  ...
  reader.onloadend = function() {
    ...
    analyzeButton.onclick = function() {
      ...
      targetURL = "https://pitchtrack.smcnus.org/mandarin-pitch-tracking-crepe";
      pyinURL = "https://pitchtrack.smcnus.org/mandarin-pitch-tracking-pyin";
      ...
      xhttp.send(JSON.stringify(wavobj));
    };
...
function createDownloadLink(blob) {
  ...
  //analyze button
  var analyzeButton = document.createElement("button");
  analyzeButton.className = "btn btn-primary btn-lg";
  analyzeButton.innerHTML = "Analyze";
  li.appendChild(document.createTextNode(" ")); //add a space in between
  li.appendChild(analyzeButton);
